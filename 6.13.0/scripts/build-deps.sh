...
yumbd ffmpeg.spec
rpmbb ffmpeg.spec
yumi ../RPMS/x86_64/ffmpeg-libs-3.4.6-1.el7.x86_64.rpm ../RPMS/x86_64/libavdevice-3.4.6-1.el7.x86_64.rpm ../RPMS/x86_64/ffmpeg-devel-3.4.6-1.el7.x86_64.rpm
...
yumi ../RPMS/x86_64/createrepo_c-0.14.3-1.el7.x86_64.rpm ../RPMS/x86_64/createrepo_c-libs-0.14.3-1.el7.x86_64.rpm
