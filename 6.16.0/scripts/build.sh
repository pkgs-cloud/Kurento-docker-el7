...
yumi ../RPMS/x86_64/kms-libusrsctp-0.9.2-1.el7.x86_64.rpm ../RPMS/x86_64/kms-libusrsctp-devel-0.9.2-1.el7.x86_64.rpm
...
yumi ../RPMS/x86_64/kms-gstreamer1-plugins-bad-1.8.1-5.el7.x86_64.rpm ../RPMS/x86_64/kms-gstreamer1-plugins-bad-devel-1.8.1-5.el7.x86_64.rpm

yumbd kms-gst-plugins-good.spec
rpmbb kms-gst-plugins-good.spec
yumi ../RPMS/x86_64/kms-gstreamer1-plugins-good-1.8.1-5.el7.x86_64.rpm
...
yumi ../RPMS/x86_64/kms-libnice-0.1.18-0.el7.x86_64.rpm ../RPMS/x86_64/kms-libnice-devel-0.1.18-0.el7.x86_64.rpm

yumbd kurento-module-creator.spec
rpmbb kurento-module-creator.spec
yumi ../RPMS/x86_64/kurento-module-creator-6.16.0-0.el7.x86_64.rpm

rpmbb kms-cmake-utils.spec
yumi ../RPMS/x86_64/kms-cmake-utils-6.16.0-0.el7.x86_64.rpm

rpmbb kms-jsonrpc.spec
yumi ../RPMS/x86_64/kms-jsonrpc-6.16.0-0.el7.x86_64.rpm ../RPMS/x86_64/kms-jsonrpc-devel-6.16.0-0.el7.x86_64.rpm

yumbd kms-core.spec
rpmbb kms-core.spec
yumi ../RPMS/x86_64/kms-core-6.16.0-0.el7.x86_64.rpm ../RPMS/x86_64/kms-core-devel-6.16.0-0.el7.x86_64.rpm

yumbd kms-elements.spec
rpmbb kms-elements.spec
yumi ../RPMS/x86_64/kms-elements-6.16.0-0.el7.x86_64.rpm ../RPMS/x86_64/kms-elements-devel-6.16.0-0.el7.x86_64.rpm

rpmbb kms-filters.spec
yumi ../RPMS/x86_64/kms-filters-6.16.0-0.el7.x86_64.rpm ../RPMS/x86_64/kms-filters-devel-6.16.0-0.el7.x86_64.rpm

yumbd kurento-media-server.spec
rpmbb kurento-media-server.spec
yumi ../RPMS/x86_64/kurento-media-server-6.16.0-0.el7.x86_64.rpm

rpmbb kms.spec
yumi ../RPMS/x86_64/kms-6.16.0-0.el7.x86_64.rpm
