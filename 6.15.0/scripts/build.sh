...
yumi ../RPMS/x86_64/kurento-module-creator-6.15.0-0.el7.x86_64.rpm

rpmbb kms-cmake-utils.spec
yumi ../RPMS/x86_64/kms-cmake-utils-6.15.0-0.el7.x86_64.rpm

rpmbb kms-jsonrpc.spec
yumi ../RPMS/x86_64/kms-jsonrpc-6.15.0-0.el7.x86_64.rpm ../RPMS/x86_64/kms-jsonrpc-devel-6.15.0-0.el7.x86_64.rpm

yumbd kms-core.spec
rpmbb kms-core.spec
yumi ../RPMS/x86_64/kms-core-6.15.0-0.el7.x86_64.rpm ../RPMS/x86_64/kms-core-devel-6.15.0-0.el7.x86_64.rpm

yumbd kms-elements.spec
rpmbb kms-elements.spec
yumi ../RPMS/x86_64/kms-elements-6.15.0-0.el7.x86_64.rpm ../RPMS/x86_64/kms-elements-devel-6.15.0-0.el7.x86_64.rpm

rpmbb kms-filters.spec
yumi ../RPMS/x86_64/kms-filters-6.15.0-0.el7.x86_64.rpm ../RPMS/x86_64/kms-filters-devel-6.15.0-0.el7.x86_64.rpm

yumbd kurento-media-server.spec
rpmbb kurento-media-server.spec
yumi ../RPMS/x86_64/kurento-media-server-6.15.0-0.el7.x86_64.rpm

rpmbb kms.spec
yumi ../RPMS/x86_64/kms-6.15.0-0.el7.x86_64.rpm
