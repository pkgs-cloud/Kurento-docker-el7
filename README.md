...
3. Enter bash within container

	```
	docker exec -it kurento-build-el76 bash
	```

4. Build Kurento RPMs including all dependencies. Run commands line by line
	...
	yumi ../RPMS/x86_64/kms-gstreamer1-1.8.1.1-1.x86_64.rpm ../RPMS/x86_64/kms-gstreamer1-devel-1.8.1.1-1.x86_64.rpm
	
	yumbd gst-plugins-base.spec
	rpmbb gst-plugins-base.spec
	yumi ../RPMS/x86_64/kms-gstreamer1-plugins-base-1.8.1.1-1.x86_64.rpm ../RPMS/x86_64/kms-gstreamer1-plugins-base-devel-1.8.1.1-1.x86_64.rpm
	...
	yumi ../RPMS/x86_64/kms-gstreamer1-plugins-bad-1.8.1-1.x86_64.rpm ../RPMS/x86_64/kms-gstreamer1-plugins-bad-devel-1.8.1-1.x86_64.rpm
	
	rpmbb gst-plugins-good.spec
	yumi ../RPMS/x86_64/kms-gstreamer1-plugins-good-1.8.1-1.x86_64.rpm
	...
	yumi ../RPMS/x86_64/kms-libnice-0.1.15.1-1.el7.x86_64.rpm ../RPMS/x86_64/kms-libnice-devel-0.1.15.1-1.el7.x86_64.rpm
